...
const genInvalid = require('./fir-gen-invalid.js');
...
const genSmem = require('./fir-gen-smem.js');
...
const getOp = (mt, nodes, opt) => {
  ...
  const opo = {
    ...
    invalid: genInvalid(mt, opt), // 5.7

    mem: genMem(mt, opt), // 5.11
    smem: genSmem(mt, opt), // CHIRRTL
